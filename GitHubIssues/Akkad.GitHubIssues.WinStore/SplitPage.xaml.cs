using Akkad.GitHubIssues.WinStore.Data;
...
namespace Akkad.GitHubIssues.WinStore
{
    /// <summary>
    /// A page that displays a group title, a list of items within the group, and details for the
    /// currently selected item.
    /// </summary>
    public sealed partial class SplitPage : Akkad.GitHubIssues.WinStore.Common.LayoutAwarePage
    {
        public SplitPage()
        {
